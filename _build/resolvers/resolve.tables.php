...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('filequeue_core_path', null,
                    $modx->getOption('core_path') . 'components/filequeue/') . 'model/';
            $modx->addPackage('filequeue', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/filequeue/model/schema/filequeue.mysql.schema.xml';
